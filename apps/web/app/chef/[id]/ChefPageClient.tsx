...
export default function ChefPageClient({ id }: { id: string }) {
  ...
  const handleSelectAndBook = (menu: MenuItem) => {
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex items-center justify-between gap-2">
                  <LikeButton id={menu.id} endpoint="/api/menus/like" />
                  <ShareButtons url={`${SITE_URL}/chef/${chef.id}`} title={`${menu.name} by ${chef.name} on Potluck`} compact />
                </div>
                <button
