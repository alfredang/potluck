                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
                      />
                    </div>
                    <div>
            ...
            <div>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@potluckhub.io</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+65 8121 3280</p>
                    <p className="text-gray-600">WhatsApp: +65 8121 3280</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="mt-4 flex gap-4">
                  <a href="#" className="rounded-full bg-gray-100 p-3 text-gray-600 hover:bg-orange-100 hover:text-orange-600">
