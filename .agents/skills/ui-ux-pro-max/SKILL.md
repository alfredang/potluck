...
> Product type ≈ two-sided marketplace + blog; optimise chef discovery and the two
> conversion funnels (book a chef / become a chef), and tighten section rhythm to cut
> dead-space. Pull palette/typography/UX rules from the CSVs, but stay inside these tokens.
